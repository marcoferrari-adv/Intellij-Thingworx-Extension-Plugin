...
public class AddDirectoryServiceAction extends JavaCreateTemplateInPackageAction<PsiClass> implements DumbAware, CreateThingworxJavaTemplateAction {

    public AddDirectoryServiceAction() {
        super("New Directory Service", "New Directory Service", ThingworxIcons.ADD_DIRECTORY_SERVICE_ICON, true);
    }

    @Override
    protected void buildDialog(@NotNull Project project, @NotNull PsiDirectory directory, CreateFileFromTemplateDialog.@NotNull Builder builder) {
        builder.setTitle("New Directory Service")
                .addKind("Directory service", ThingworxIcons.ADD_DIRECTORY_SERVICE_ICON, "Directory Service Template");
    }
    ...
    protected @NlsContexts.Command String getActionName(PsiDirectory directory, @NonNls @NotNull String newName, @NonNls String templateName) {
        return "Create Directory Service " + newName;
    }
    ...
    public void addThingMetadataReference(Project project, PsiJavaFile psiJavaFile, PsiClass psiClass) {
        ...
        metadata.addDirectoryService(className);
    }
}
