...
public class AddAuthenticatorAction extends JavaCreateTemplateInPackageAction<PsiClass> implements DumbAware, CreateThingworxJavaTemplateAction {

    public AddAuthenticatorAction() {
        super("New Authenticator", "New Authenticator", ThingworxIcons.ADD_AUTHENTICATOR_ICON, true);
    }

    @Override
    protected void buildDialog(@NotNull Project project, @NotNull PsiDirectory directory, CreateFileFromTemplateDialog.@NotNull Builder builder) {
        builder.setTitle("New Authenticator")
                .addKind("Authenticator", ThingworxIcons.ADD_AUTHENTICATOR_ICON, "Authenticator Template");
    }
    ...
    protected @NlsContexts.Command String getActionName(PsiDirectory directory, @NonNls @NotNull String newName, @NonNls String templateName) {
        return "Create Authenticator " + newName;
    }
    ...
    public void addThingMetadataReference(Project project, PsiJavaFile psiJavaFile, PsiClass psiClass) {
        ...
        metadata.addAuthenticator(className);
    }
}
