...
public class AddScriptFunctionLibraryAction extends JavaCreateTemplateInPackageAction<PsiClass> implements DumbAware, CreateThingworxJavaTemplateAction {

    public AddScriptFunctionLibraryAction() {
        super("New Script Function Library", "New Script Function Library", ThingworxIcons.ADD_SCRIPT_FUNCTION_LIB_ICON, true);
    }

    @Override
    protected void buildDialog(@NotNull Project project, @NotNull PsiDirectory directory, CreateFileFromTemplateDialog.@NotNull Builder builder) {
        builder.setTitle("New Script Function Library")
                .addKind("Script function library", ThingworxIcons.ADD_SCRIPT_FUNCTION_LIB_ICON, "Script Function Library Template");
    }
    ...
    protected @NlsContexts.Command String getActionName(PsiDirectory directory, @NonNls @NotNull String newName, @NonNls String templateName) {
        return "Create Script Function Library " + newName;
    }
    ...
    public void addThingMetadataReference(Project project, PsiJavaFile psiJavaFile, PsiClass psiClass) {
        ...
        metadata.addScriptFunctionLibrary(className);
    }
}
